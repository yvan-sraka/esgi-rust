...
> Yuck! *"transpilation"* ... JavaScript (ES2020) *turn by Babel magic
> into* JavaScript (ES3 compatible)

WebAssembly is an [S-expression
language](https://en.wikipedia.org/wiki/S-expression) that run in modern
browser or in `wasmtime` (sandboxing) that work with **WASI**: the
WebAssembly System Interface

Lvl 0
-----

-   Install `wasm-pack` (to compile your Rust lib in `.wasm` and more)
    <https://rustwasm.github.io/docs/wasm-pack/>
-   Install `wasmtime` (to run a `.wasm` binary program, or `.wat` text
    format) <https://wasmtime.dev>
...
We write a small program that turns Markdown (<https://commonmark.org>)
into HTML as describe in the video <https://youtu.be/Qn_4F3foB3Q>
...
The result is here:
<https://github.com/yvan-sraka/markdown-viewer/blob/master/src/lib.rs>
...
-   Article
    <https://dev.to/shritesh/writing-a-brainfuck-interpreter-in-rust-and-webassembly-13f>
...
There is an awesome Tutorial "Conway's Game of Life" on the official
guide:
...
Binary Toolkit (useful for debugging):
<https://github.com/WebAssembly/wabt>

Play also with <https://github.com/WebAssembly/binaryen> and
<https://www.npmjs.com/package/rust-wasm-loader>

Mozilla Hacks cool tech blog
...
Web UI Frameworks based on WebAssembly:

-   <https://github.com/hecrj/iced>
-   <https://yew.rs/docs/getting-started/project-setup>
-   <https://github.com/gabisurita/fullstack-rust>

Another way to solve *\" the JavaScript issue \"*:

-   **BinAST** <https://github.com/tc39/proposal-binary-ast/> &
...
Happy COVID-19 quarantine, [no easter
eggs](https://www.youtube.com/watch?v=dQw4w9WgXcQ) this year ...
